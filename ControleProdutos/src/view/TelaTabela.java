...
public class TelaTabela extends javax.swing.JInternalFrame {
    ...
    public TelaTabela() {
        initComponents();
        DefaultTableModel mod = (DefaultTableModel) produto6.getModel();
        produto6.setRowSorter(new TableRowSorter(mod));
        //Apaga o topo
        BasicInternalFrameUI janela = (BasicInternalFrameUI)this.getUI();
        janela.setNorthPane(null);
    ...
    private void jButton21ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton21ActionPerformed
        ...
        if ((!txt16.getText().isEmpty()) && (!txt17.getText().isEmpty()) && (!txt18.getText().isEmpty())) {
            if(txt17.getText().matches("[0-9]*") && txt18.getText().matches("[0.0-9]*")){
                ...
                Object[] dados = {w,txt16.getText(),txt17.getText(),txt18.getText()};
    ...
    private void jButton22ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton22ActionPerformed
        ...
        if(produto6.getSelectedRow() != -1){ //Ele tem de padrão -1
            ...
            produto p = new produto();
            p.setId((int) produto6.getValueAt(produto6.getSelectedRow(),0));
            produtoDAO dao = new produtoDAO();
            dao.deleta(p);
            DefaultTableModel produtos = (DefaultTableModel) produto6.getModel();
            produtos.removeRow(produto6.getSelectedRow());
        }else{
    ...
    private void jButton23ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton23ActionPerformed
        ...
        if (!txt16.getText().isEmpty() && !txt17.getText().isEmpty() && !txt18.getText().isEmpty()) {
            if(produto6.getSelectedRow() != -1){
                produto6.setValueAt(txt16.getText(), produto6.getSelectedRow(),1);
                produto6.setValueAt(txt17.getText(), produto6.getSelectedRow(),2);
                produto6.setValueAt(txt18.getText(), produto6.getSelectedRow(),3);
                produto p = new produto();
                w = produto6.getSelectedRow() + 1;
                p.setId(w);
                p.setNome(txt16.getText());
                p.setQuantidade(Integer.parseInt(txt17.getText()));
                p.setPreco(Double.parseDouble(txt18.getText()));
